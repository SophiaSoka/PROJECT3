...
int main()
{
    // This will display the initial map based on level and the number of pirates
    // Included assert statements to test the traps and pirates
    Map map;
    ...
    // Uses a for loop for the map display to ask the user which way they want to move using w,a,s,d
    char dir;
    for(int i = 0; i < 100; i++){
    ...
    // Test cases for the traps we implemented into the map
    /*
    ...
    // Test cases for the pirates we implemented into the map
